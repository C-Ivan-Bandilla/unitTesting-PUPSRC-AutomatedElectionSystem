...
.form-control:focus {
  ...
  outline: 0; 
  font-weight: 500;
  box-shadow: 0 0 4px 0 rgb(71, 105, 177, 0.25)
}
...
.btn-primary {
  ...
  --bs-btn-bg: #C82D26;
  /* --bs-btn-border-color: #C82D26; */
  --bs-btn-border-color:var(--main-color);
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #C82D26;
  --bs-btn-hover-border-color: #C82D26;
  --bs-btn-focus-shadow-rgb: 49, 132, 253;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #C82D26;
  --bs-btn-active-border-color: #C82D26;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
  --bs-btn-disabled-bg: #C82D26;
  --bs-btn-disabled-border-color: #C82D26;
}
.btn-main-primary {
  /* --bs-btn-color: #fff; */
  --bs-btn-color: var(--main-color);
...
.btn-danger {
  --bs-btn-color: #fff;
  --bs-btn-bg: #EE1C24;
  --bs-btn-border-color: #EE1C24;
  --bs-btn-hover-color: #fff;
  --bs-btn-hover-bg: #bb2d3b;
  --bs-btn-hover-border-color: #b02a37;
  --bs-btn-focus-shadow-rgb: 225, 83, 97;
  --bs-btn-active-color: #fff;
  --bs-btn-active-bg: #EE1C24;
  --bs-btn-active-border-color: #EE1C24;
  --bs-btn-active-shadow: inset 0 3px 5px rgba(0, 0, 0, 0.125);
  --bs-btn-disabled-color: #fff;
...
.dropdown-item {
  ...
  background-color: transparent;
  border: 0;
  border-radius: var(--bs-border-radius-lg, 0);
}
...
.modal {
  ...
  --bs-modal-padding: 0rem 1.5rem 2rem 1.5rem;
...
.border-primary {
  --bs-border-opacity: 1;
  border-color: var(--validate-blue) !important;
}
.border-secondary {
  --bs-border-opacity: 1;
  border-color: rgba(
