...
if($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!$row) {
        setErrorAndRedirect('Your password reset link was not found.', NULL, NULL, '../voter-login');
    }
    ...
    if ($expiry_time <= $current_time) {
        setErrorAndRedirect('Your password reset link has expired.', NULL, NULL, '../voter-login');
    }
...
function setErrorAndRedirect($message, $token, $org_name, $redirect_url = '../reset-password') {
