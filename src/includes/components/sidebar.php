		...
		<div class="header-right">
			<div class="dropdown user-profile">
				...
				<ul class="dropdown-menu dropdown-menu-end main-color p-3" aria-labelledby="dropdownMenuButton">
					...
					<li class="px-xl-2 py-xl-1"><a class="dropdown-item" href="#"><i data-feather="clock" class="fs-11 main-color mb-xl-1"></i><span style="padding-left: .8rem">Activity Log</a></li>
